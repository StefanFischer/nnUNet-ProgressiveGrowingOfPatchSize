...
Originally, pytorch would prevent normalization over 1-sized tensors in the InstanceNorm3d layer. But this does not hurt/create any problems for the curriculum.
"""
...
class nnUNetTrainer_ProgressiveGrowingOfPatchSize_Efficiency(nnUNetTrainer):
    ...
    def plan_batch_size(self):
        ...
        def compute_batch_size(cur_ps, max_ps):
            # keep constant batch size for efficiency mode
