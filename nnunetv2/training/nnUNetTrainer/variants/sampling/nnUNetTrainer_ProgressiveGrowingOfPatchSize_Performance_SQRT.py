    ...
    def generate_train_batch(self):
        ...
        for j, i in enumerate(selected_keys):
            ...
            if j % crops_per_volume == 0:
                ...
                self.force_fg = not self.force_fg
            else:
            ...
            bbox_lbs, bbox_ubs = self.get_bbox(shape, self.force_fg, properties['class_locations'], old_crop=old_crop)
...
class nnUNetTrainer_ProgressiveGrowingOfPatchSize_Performance_SQRT(nnUNetTrainer):
