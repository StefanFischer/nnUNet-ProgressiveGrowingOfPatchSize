...
class nnUNetTrainer_ProgressiveGrowingOfPatchSize_Performance_SingleVolume(nnUNetTrainer):
...
# nnUNetv2_train 6 3d_fullres 0 -tr nnUNetTrainer_ProgressiveGrowingOfPatchSize_Performance_SingleVolume
